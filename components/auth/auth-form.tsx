...
function safeError(mode: Mode, status: number, message?: unknown) {
  ...
  const allowed = ["Check your name, email, and password.", "Enter a valid email address.", "Enter a valid email and password.", "This account is currently disabled.", "Email delivery is temporarily rate-limited. Please try again later.", "Authentication is temporarily rate-limited. Try again later."];
