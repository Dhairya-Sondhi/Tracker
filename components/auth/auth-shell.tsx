...
export function AuthShell({ children }: { children: React.ReactNode }) {
  return (
    <main data-theme="dark" className="relative grid min-h-dvh place-items-center overflow-hidden bg-[#09090d] px-5 py-24 text-white sm:px-8">
      ...
      <Link href="/" aria-label="Vlocity home" className="focus-ring absolute left-5 top-5 z-10 rounded-xl text-[15px] sm:left-8 sm:top-8">
        <VlocityBrand markClassName="size-8 text-white" />
      </Link>
